...
public class ListDatum {
    ...
    @Expose
    private Float fullyDilutedValuation;
    ...
    public Float getMarketCapRank() {
        return marketCapRank;
    }

    public void setMarketCapRank(Float marketCapRank) {
        this.marketCapRank = marketCapRank;
    }

    public Float getFullyDilutedValuation() {
        return fullyDilutedValuation;
    }

    public void setFullyDilutedValuation(Float fullyDilutedValuation) {
